...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-[#2D3353]">UX/UI Design Course</span>
        </nav>
        ...
        Transform your career by mastering the art and science of User Interface (UI) and User Experience (UX) design. In just 16 weeks, you will develop essential skills to create intuitive and engaging user interfaces. </p>
    ...
    <div className="bg-stone-50  flex items-center justify-center py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6">
         ...
         Our UX/UI Design Course
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
       An intensive program to learn the UX/UI designer profession and launch your new career.</p>
