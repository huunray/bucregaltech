...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-[#2D3353]">Back-End Developer Course - Node.js & Express</span>
        </nav>
            <h1 className="text-4xl md:text-4xl font-extrabold text-gray-900 leading-tight mb-4">
        Back-End Developer Course - Node.js & Express
            </h1>
            <p className="text-3xl md:text-4xl font-bold text-green-700 mb-6">
             
            </p>
            <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-8">
            Choose the best training program to become a back-end development expert with Node.js and Express. In 16 weeks, learn to design and build robust, scalable APIs, manage databases, and develop a portfolio of secure, real-world server applications.</p>
    ...
    <div className="bg-stone-50  flex items-center justify-center py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6">
          ...
          BUC REGAL TECH'S Back-End Developer Training
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
  Training to learn the profession of Back-end development and launch your new career.          </p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-3xl md:text-3xl font-extrabold text-gray-900 leading-tight mb-6">
            Boost Your Skills with  <br />Experienced and Passionate Guides
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
              Our teachers are not only seasoned specialists in their field, they are true companions dedicated to your success. They generously share their knowledge with you and guide you with kindness on the path to success. 
          </p>
...
export default SoftwareFrontEnd;