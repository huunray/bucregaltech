...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-[#2D3353]">Introduction to Web Programming</span>
        </nav>
           ...
           Transform your career with our Web Development Course. In 12 weeks, become an expert in creating interactive and responsive websites.  </p>
          ...
          <ActionButtons1 />
            ...
            <div className="space-y-4">
              <div className="flex items-center text-gray-700 text-lg">
                <FaClock className="mr-4 [#2D3353] text-2xl" />
    ...
    <div className="bg-stone-50  flex items-center justify-center py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6">
          ...
          Our Web Developer Training in Nigeria
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
           Intensive training to become a web programming expert and launch your new career in web development. </p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-3xl md:text-3xl font-extrabold text-gray-900 leading-tight mb-6">
            Master the Art of Web Development with <br /> Coding Enthusiast
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
          Our trainers, true experts in their field, share their passion and guide you to success in the world of web development.
          </p>
...
export default SoftwareIntroduction ;