...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-[#2D3353]">Cybersecurity – CompTIA Security+ Certified</span>
        </nav>
           ...
           Choose the best training program to get started or improve your cybersecurity skills. In 20 weeks, acquire the skills necessary to protect computer systems and obtain CompTIA Security+ certification.</p>
    ...
    <div className="bg-stone-50  flex items-center justify-center py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6">
          ...
          Intensive training to learn computer security and launch your new career.  </p>
...
const SinglePageDetailCybersecurityCompTIA = () => {
  return (
    <div> 
              <CourseHeroSection />
              <BroadSkillShowcase />
...
export default SinglePageDetailCybersecurityCompTIA;