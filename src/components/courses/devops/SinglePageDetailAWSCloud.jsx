...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-[#2D3353]">AWS Cloud Practitioner Certification Preparation</span>
        </nav>
         ...
         Build a strong foundation in cloud computing and prepare for the AWS Certified Cloud Practitioner certification. Gain hands-on experience managing core AWS services, securing data, and optimizing cloud operations to confidently step into cloud roles.</p>
    ...
    <div className="bg-stone-50  flex items-center justify-center py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6">
          ...
          Launch Your Cloud Career with AWS
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
          Step into cloud computing with immersive, hands-on training. Gain practical skills, earn your AWS Certified Cloud Practitioner certification, and open doors to new opportunities in tech and cloud careers.  </p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-3xl md:text-3xl font-extrabold text-gray-900 leading-tight mb-6">
            Master AWS  with <br /> Passionate Experts
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
            Our instructors, true experts and enthusiasts, are dedicated to passing on their know-how to guide you towards excellence in AWS.
          </p>
...
const SinglePageDetailAWSCloud = () => {
  return (
    <div> 
              <CourseHeroSection />
              <BroadSkillShowcase />
...
export default SinglePageDetailAWSCloud;