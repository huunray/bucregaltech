...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-[#2D3353]">Introduction to Cybersecurity</span>
        </nav>
          ...
          This program serves as an introductory course to the field of cybersecurity. By completing this track, you will acquire a solid understanding of the fundamental principles of cybersecurity, which will enable you to embark on an exciting career in the industry. </p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6">
          <h1 className="text-4xl font-bold text-gray-800 leading-tight">
           Our Cybersecurity course in Nigeria
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
           Learn to harness Cybersecurity  in your work and business. Gain hands-on experience with AI tools, automate tasks, create content, and turn data into actionable insights, all through practical projects and real-world applications.
          </p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-3xl md:text-3xl font-extrabold text-gray-900 leading-tight mb-6">
            Master Cybersecurity with <br /> Passionate Experts
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
            Our instructors, true experts and enthusiasts, are dedicated to passing on their know-how to guide you towards excellence in Cybersecurity.
          </p>
