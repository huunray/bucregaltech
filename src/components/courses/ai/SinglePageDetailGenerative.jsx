...
import Hero from '../../../assets/Data/afro-tech.jpg';
...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-indigo-600">Generative AI Course</span>
        </nav>
            ...
            Discover Generative AI and learn how to apply it to your professional life and business. In just 12 weeks, gain hands-on experience with AI tools and explore practical applications across multiple domains to boost productivity, creativity, and decision-making.
            </p>
...
const SinglePageDetailGenerative = () => {
  return (
    <div> 
              <CourseHeroSection />
              <BroadSkillShowcase />
...
export default SinglePageDetailGenerative;