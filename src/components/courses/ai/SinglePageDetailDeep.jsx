// Current Location: src/components/courses/ai/SinglePageDetailDeep.jsx

// --- COMPONENT IMPORTS (Go UP 2 levels) ---
// Note: Adding the .jsx or .tsx extension is crucial for reliable resolution.
import TestimonialsSection from '../../TestimonialsSection.jsx';
import Footer from '../../Footer.jsx';
import JoinTrainingBanner from '../../JoinTrainingBanner.jsx';
import NextSessions from '../../NextSessions.jsx';
import ActionButtons from '../../ActionButtons.jsx';
import BroadSkillShowcase from '../../BroadSkillShowcase.tsx'; // Use .tsx for this file

// --- ASSET IMPORTS (Go UP 3 levels, then into assets) ---
import Hero from '../../../assets/Data/data1.png';
import ai from '../../../assets/design/new.jpg';
import ExpertImage from '../../../assets/Data/Rectangle.png'; 

// --- REMAINING IMPORTS (No change needed) ---
import { Link } from 'react-router-dom'; 
import { FaClock, FaCalendarAlt, FaBook, FaMoon } from 'react-icons/fa'; 
import { FaBolt, FaUsers, FaGraduationCap } from 'react-icons/fa';
...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-indigo-600">Deep Learning - NVIDIA Certified</span>
        </nav>
            <h1 className="text-4xl md:text-4xl font-extrabold text-gray-900 leading-tight mb-4">
       Deep Learning - NVIDIA Certified
            </h1>
            <p className="text-3xl md:text-4xl font-bold text-green-700 mb-6">
             
            </p>
            <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-8">
          Master the fundamentals of deep learning and accelerate your career with our NVIDIA-certified training program. Gain hands-on experience with cutting-edge tools and frameworks, build powerful AI models, and learn how to apply them to real-world challenges across industries. </p>
    ...
    <div className="bg-stone-50  flex items-center justify-center py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6">
          ...
          An intensive program designed to help you master deep learning techniques and kick-start your career in artificial intelligence. </p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-3xl md:text-3xl font-extrabold text-gray-900 leading-tight mb-6">
            Master Deep Learning with <br /> Passionate Experts
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
            Our instructors, true experts and enthusiasts, are dedicated to passing on their know-how to guide you towards excellence in Deep Learning.
          </p>
...
export default SinglePageDetailDeep;