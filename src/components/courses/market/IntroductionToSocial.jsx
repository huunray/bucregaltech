...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-indigo-600">Introduction to Social Media Training</span>
        </nav>
      ...
      Elevate your career with our professional Social Media Training. In 12 weeks, become a digital communication specialist and master the creation and management of effective social media campaigns. </p>
    ...
    <div className="bg-stone-50  flex items-center justify-center py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6">
         ...
         Our Social Media & Community Management Training
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
  Intensive training to become an expert in social media communication and launch your new career.</p>
...
export default IntroductionToSocial;