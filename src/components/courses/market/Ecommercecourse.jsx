...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-indigo-600">E-commerce course: Build your online store</span>
        </nav>
            <h1 className="text-4xl md:text-4xl font-extrabold text-gray-900 leading-tight mb-4">
           E-commerce course: Build your online store
            </h1>
            <p className="text-3xl md:text-4xl font-bold text-green-700 mb-6">
             
            </p>
            <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-8">
       Ready to bring your business idea to life? BUS REGAL TECH'S Shopify Beginner’s Guide will teach you everything you need to know to build and launch your own Shopify store. From setting up your account to driving traffic, you’ll gain the skills to turn your online store into a successful, profitable venture. </p>
  ...
  return (
    <div className="bg-stone-50  flex items-center justify-center py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        Our Introduction to E-Commerce Course
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
   This introductory course empowers you with the fundamental skills to create and run a successful online store, whether for personal projects or business ventures.</p>
    ...
    <section className="bg-gradient-to-br from-gray-50 to-orange-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center">
         ...
         Master E-Commerce Fundamentals with    <br />Expert Instructors 
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
   Our instructors, true experts and passionate about e-commerce, are dedicated to sharing their knowledge and guiding you toward mastering Shopify, helping you create and scale a successful online store.</p>
