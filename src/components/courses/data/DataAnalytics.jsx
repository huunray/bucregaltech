    ...
    <div className="bg-stone-50  flex items-center justify-center py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6">
          ...
          Data Analyst Training: Launch Your Career with Confidence
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
        Dive into the world of Data Analytics with intensive training that opens doors to a new career full of potential.</p>
    ...
    <section className="bg-gradient-to-br from-gray-50 to-orange-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center">
         ...
         Learning with Passionate Experts   <br />and Personalized Support
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
       Our instructors are more than recognized experts in their field; they are passionate mentors who share their expertise with enthusiasm. They don't just impart knowledge, but guide and encourage you to develop your full potential. </p>
