...
          <Link to="/" className="hover:underline">Home</Link>   &gt; <span className="font-bold text-[#2D3353]">Data Scientist Course - NVIDIA Certified</span>
        </nav>
            <h1 className="text-4xl md:text-4xl font-extrabold text-gray-900 leading-tight mb-4">
            Data Scientist Course - NVIDIA Certified
            </h1>
            <p className="text-3xl md:text-4xl font-bold text-green-700 mb-6">
             
            </p>
            <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-8">
        Choose the best training program to transition into the field of Data Science. In 20 weeks, become a data analysis expert and develop a solid portfolio. </p>
    ...
    <div className="bg-stone-50  flex items-center justify-center py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6">
          ...
          Our Data Scientist Training in Nigeria
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
         An intensive training program to master the profession of Data Scientist and launch your new career.</p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-3xl md:text-3xl font-extrabold text-gray-900 leading-tight mb-6">
           Acquire New Skills with  <br />Passionate Instructors
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
         Our trainers are recognized experts in their field, dedicated to sharing their know-how. </p>

          <ul className="space-y-6">
            <li className="flex items-start text-gray-700">
              <FaUsers className="mt-1 mr-3 [#2D3353] text-2xl flex-shrink-0" />
              <span>
