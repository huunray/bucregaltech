...
const WebsiteDevelopmentDetail = () => {
   useEffect(() => {
...
              We build custom websites that are not only visually stunning but also highly functional and optimized for performance. Our focus is on creating responsive, user-friendly experiences that help you achieve your business goals.
            </p>
            <p className="text-gray-600 font-montserrat">
              From a simple landing page to complex e-commerce platforms, we handle the entire development lifecycle. We use modern frameworks and best practices to ensure your site is secure, scalable, and ready for the future.
            </p>
            <div className="space-y-2 mt-6">
              <h3 className="text-xl font-bold text-gray-900 font-syne">Our Technology Stack:</h3>
              <p className="text-gray-600 font-montserrat">
                HTML5, CSS3, JavaScript (ES6+), React, Node.js, Express, MongoDB, Tailwind CSS, REST APIs, Git.
              </p>
            </div>
...
              <img
                   src={scheduleImage}                 
                 alt="Website Development Graphic"
...
          <h2 className="text-3xl font-bold font-syne text-center mb-10">Our Development Stack</h2>
          <div className="bg-white rounded-xl shadow-md p-6 max-w-2xl mx-auto">
            <div className="flex items-center space-x-4 mb-4">
              <img src="https://placehold.co/50x50/E2E8F0/A0AEC0?text=Stack" alt="Tech Stack Icon" className="rounded-full" />
...
            </div>
            <p className="text-gray-600 font-montserrat">
              We specialize in the MERN stack (MongoDB, Express.js, React, Node.js) to build fast, scalable, and dynamic web applications.
            </p>
            <div className="mt-4 flex flex-wrap gap-2 text-sm text-gray-500 font-montserrat">
              <span className="bg-gray-200 rounded-full px-3 py-1">React</span>
              <span className="bg-gray-200 rounded-full px-3 py-1">Node.js</span>
              <span className="bg-gray-200 rounded-full px-3 py-1">MongoDB</span>
            </div>
          </div>
        </div>
      </section>
...
export default WebsiteDevelopmentDetail;
